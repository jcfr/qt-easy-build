...
$url = ('https://raw.githubusercontent.com/commontk/qt-easy-build/' + $qtBuildScriptVersion + '/cmake/' + $qtBuildScriptName)
...
$url = ('https://raw.githubusercontent.com/commontk/qt-easy-build/' + $qtBuildScriptVersion + '/cmake/' + $scriptName)
