...
function(qeb_get_openssl_binaries_download_url bits qt_platform openssl_version url_var md5_var)
  ...
  if(QT_PLATFORM STREQUAL "win32-msvc2015")
    if(BITS EQUAL 64)
      set(OPENSSL_URL "http://packages.kitware.com/download/bitstream/10455/OpenSSL_1_0_1h-install-msvc1900-64.tar.gz")
      set(OPENSSL_MD5 "f93d266def384926015550452573e824")
    else()
      set(OPENSSL_URL "http://packages.kitware.com/download/bitstream/10458/OpenSSL_1_0_1h-install-msvc1900-32.tar.gz")
      set(OPENSSL_MD5 "e0e26ae6ac5693d266c804e738d7aa14")
    endif()
